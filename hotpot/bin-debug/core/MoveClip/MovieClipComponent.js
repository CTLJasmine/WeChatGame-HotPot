...
var MovieClipComponent = (function (_super) {
    ...
    MovieClipComponent.prototype.createMoviClip = function () {
        ...
        var texture;
        if (this.mIsLoad) {
            MovieClipResLoader.getInstance().load(this.mName, function (_config, _texture) {
                data = _config;
                texture = _texture;
    ...
    MovieClipComponent.mCacheDict = {};
    return MovieClipComponent;
}(eui.Component));
__reflect(MovieClipComponent.prototype, "MovieClipComponent", ["eui.UIComponent", "egret.DisplayObject"]);
var MovieClipResLoader = (function (_super) {
    __extends(MovieClipResLoader, _super);
    function MovieClipResLoader() {
        var _this = _super.call(this) || this;
        _this.mIsloadConfig = false;
        _this.mIsloadTexture = false;
        return _this;
    }
